<template>
  <div class="p-6">
    <div class="mb-6">
      ...
      <p class="text-gray-600 mt-2">Manage hotel rooms and inventory</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
      <div class="text-center">
        ...
        >
          <i class="pi pi-home text-purple-600 text-2xl"></i>
        </div>
        <h3 class="text-lg font-medium text-gray-900 mb-2">Room Management</h3>
        <p class="text-gray-500 mb-4">This page will contain room management features including:</p>
